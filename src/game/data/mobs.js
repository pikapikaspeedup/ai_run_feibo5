...
export const MOBS = {
  ...
  email:  { name: '未读邮件', hp: 11, spd: 105, touch: 2, xp: 1.6, jig: false, spr: 'mob_email',
    upgradeAfter: 5, upgradeTo: 'urgent_email' },
  urgent_email: { name: '加急邮件', hp: 13, spd: 130, touch: 3, xp: 2.0, jig: false, spr: 'mob_urgent_email' },
  sticky: { name: '待办便利贴', hp: 20, spd: 60, touch: 3.2, xp: 2.2, jig: false, spr: 'mob_sticky' },
  cr:     { name: '需求变更单', hp: 14, spd: 95, touch: 2.5, xp: 1.6, jig: true, split: true, spr: 'mob_cr' },
  ...
  read_reply: { name: '已读不回', hp: 3, spd: 160, touch: 1, xp: 1, jig: false, spr: 'mob_readreply' },
  ...
  message_recall: { name: '已发送-撤回中', hp: 12, spd: 100, touch: 2, xp: 2, jig: false,
  ...
  outsourced_army: { name: '临时工外包大军', hp: 5, spd: 140, touch: 1.2, xp: .8, jig: false,
  ...
  paper_minion: { name: 'A4 纸人', hp: 1, spd: 150, touch: 1, xp: .5, jig: true, spr: 'mob_paperman' },
