...
export const WEAPONS = {
  ...
  /* ---- v3.1 玄学科 6 把（SP：精神防御装备，见 dcos/weapons-v3.1-design.md） ---- */
  wooden_fish: { name: '电子木鱼', country: 'SP', color: '#e8c96a',
    tagline: '上班敲一敲，功德少不了',
    pat: '自动敲击攒功德，每 10 声放金色功德冲击环（击退清场）',
    kind: 'karma', cd: .5, dmg: 3, tapCd: .5, need: 10, novaR: 78, novaDmg: 24, range: 85 },
  reject_stamp: { name: '「驳回」印章', country: 'SP', color: '#d43a2f',
    tagline: '一章在手，需求全休',
    pat: '巨型红章随机空袭敌群，砸中盖"驳回"红印',
    kind: 'stamp', cd: 1.5, dmg: 20, stampR: 46, range: 300 },
  kickball: { name: '踢皮球', country: 'SP', color: '#f2efe6',
    tagline: '这事不归我管，归它管',
    pat: '皮球在墙壁间无限弹射，越踢越快',
    kind: 'bounce', cd: 1.7, dmg: 13, spd: 230, range: 9999, maxBounce: 14 },
  leek_box: { name: '隔夜韭菜盒子', country: 'SP', color: '#8fe08a',
    tagline: '谁靠近谁知道',
    pat: '贴身恶臭光环持续伤害+减速——这回被割的是他们',
    kind: 'aura', cd: .5, dmg: 3.4, tickCd: .5, range: 62 },
  legacy_todo: { name: '历史遗留问题', country: 'SP', color: '#c9a06a',
    tagline: '我走过的路，都是坑',
    pat: '移动时沿路埋 //TODO 坑，敌人踩中爆炸——跑图流本命',
    kind: 'mine', cd: .8, dmg: 15, triggerR: 26, fuseT: .25, r: 46, range: 60 },
  ac_leak: { name: '空调漏水', country: 'SP', color: '#6ab8e8',
    tagline: '中央空调，中央漏水',
    pat: '头顶随机滴水成减速水滩，物业已读不回',
    kind: 'rain', cd: 1.1, dmg: 8, dropR: 34, poolT: 2.6, range: 150 },

  /* ---- v3.1 风暴科 6 把（ST：机制=梗一体化线） ---- */
  fw_mail: { name: '群发转发邮件', country: 'ST', color: '#9ad1ff',
    tagline: 'FW:FW:FW:FW:',
    pat: '纸飞机命中后弹向下一个人，谣言越传伤害越高',
    kind: 'ricochet', cd: .8, dmg: 9, spd: 300, range: 260, hops: 3, hopMult: 1.15 },
  req_split: { name: '需求拆解', country: 'ST', color: '#ffd9a0',
    tagline: '一个需求进去，一堆需求出来',
    pat: '大需求命中裂成 3 个子需求扇形飞出，满级再裂孙需求',
    kind: 'split', cd: 1.0, dmg: 13, spd: 280, range: 240, splitN: 3, splitDmg: .5 },
  fire_req: { name: '火线需求', country: 'ST', color: '#ff6a3d',
    tagline: '不是需求着火，是需求就是火',
    pat: '落点铺一道燃烧便签墙，灼烧+减速拦路',
    kind: 'firewall', cd: 2.2, dmg: 9, wallLen: 5, wallT: 3, range: 170 },
  boss_slam: { name: '领导拍板', country: 'ST', color: '#ffcf33',
    tagline: '就这么定了！',
    pat: '巨掌拍击重伤+击飞，被拍飞的撞到别人传递冲击伤（人撞人保龄球）',
    kind: 'slam', cd: 1.3, dmg: 28, reach: 70, arc: 1.5, kb: 60, range: 80 },
  layoff_blade: { name: '裁员大刀', country: 'ST', color: '#ff4f6a',
    tagline: '刀刀毕业',
    pat: '挥砍放出贯穿全屏路径的"毕业"刀气月牙，一刀一条走廊',
    kind: 'slashwave', cd: .9, dmg: 17, spd: 260, range: 300, waveW: 9 },
  force_meeting: { name: '强制拉会', country: 'ST', color: '#b665ff',
    tagline: '有个会，先拉一下',
    pat: '丢出会议邀请生成引力漩涡，把杂鱼拽成一坨再小爆',
    kind: 'vortex', cd: 2.4, dmg: 16, pullR: 90, pullT: 1.2, spd: 220, range: 200 },
};
...
export const LEGENDS = {
  ...
  /* ---- v3.1 玄学科/风暴科传说 ×6 ---- */
  karma_forest: { name: '电子功德林', color: '#ffe27a',
    tagline: '功德攒够了，就轮到你驳回世界。',
    pat: '功德环高频脉冲 + 每 4s 全屏随机 6 连"驳回"章雨',
    kind: 'leg_karma', cd: .4, dmg: 8, tapCd: .35, need: 6, novaR: 95, novaDmg: 32,
    stampCd: 4, stampN: 6, stampDmg: 28, stampR: 50, range: 100 },
  viral_storm: { name: '舆情失控', color: '#7ac8ff',
    tagline: '转发过百，真相下班。',
    pat: '弹射每一跳都分裂子弹（指数扩散，全屏 FW: 满天飞）',
    kind: 'leg_viral', cd: .7, dmg: 11, spd: 320, range: 300, hops: 4, hopMult: 1.15, splitN: 2, splitDmg: .45 },
  grad_party: { name: '毕业典礼', color: '#ff8f5a',
    tagline: '今天，我们都有光明的前途。',
    pat: '巨掌拍板 + 四向"毕业"刀气 + 被拍飞的敌人化作撞击伤害源',
    kind: 'leg_gradparty', cd: 1.2, dmg: 34, reach: 84, arc: 1.7, kb: 85, waveDmg: 20, spd: 280, range: 92 },
  crematorium: { name: '项目火葬场', color: '#ff5f3d',
    tagline: '需求进来的时候，谁也没想过怎么出去。',
    pat: '大漩涡拽入全场杂鱼，结束时外圈合拢一圈火墙',
    kind: 'leg_crema', cd: 2.6, dmg: 22, pullR: 130, pullT: 1.5, spd: 220, range: 220, ringDps: 14 },
  pot_relay: { name: '击鼓传锅', color: '#c9c4b4',
    tagline: '锅不会消失，只会转移。',
    pat: '大铁锅弹射沿途埋雷，弹尽时范围甩锅爆炸',
    kind: 'leg_pot', cd: 1.8, dmg: 22, spd: 250, range: 9999, maxBounce: 10, mineEvery: .35, mineDmg: 16, boomR: 60 },
  biohazard: { name: '茶水间生化事故', color: '#8fe08a',
    tagline: '这个味道，工位半径五米内不宜生存。',
    pat: '恶臭圈半径翻倍 + 圈内持续长出毒水滩向外蔓延',
    kind: 'leg_bio', cd: .45, dmg: 5, tickCd: .45, range: 110, poolCd: .8, poolDps: 8, poolT: 3 },
  /* ---- v2.9 办公室近战线传说 ×2 ---- */
...
export const RECIPES = [
  ...
  /* v3.1 玄学科 + 风暴科 */
  ['wooden_fish', 'reject_stamp', 'karma_forest'],
  ['kickball', 'legacy_todo', 'pot_relay'],
  ['leek_box', 'ac_leak', 'biohazard'],
  ['fw_mail', 'req_split', 'viral_storm'],
  ['layoff_blade', 'boss_slam', 'grad_party'],
  ['fire_req', 'force_meeting', 'crematorium'],
];
